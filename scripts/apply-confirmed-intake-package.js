...
const catalog = {
  ...
  "rw-color-script-emotional-continuity": {
    ...
    actions: ["create_story_task", "generate_storyboard", "repair_storyboard", "validate_result"],
    contextSummary: "Color, light, material, and air cues must serve the current beat and adjacent-row emotional continuity without generic style switches or unsupported atmosphere.",
    reviewedAtBucket: "2026-05-27",
  },
